      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground font-medium">
            치지직 Open API 앱 삭제 방지 및 연동 상태를 관리합니다.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm space-y-2 font-medium opacity-90 list-disc ml-4">
                  ...
                  <li>본 페이지의 Keep-alive 기능을 실행하면 저장된 계정으로 <code>/open/v1/users/me</code>를 호출하여 실적을 발생시킵니다.</li>
                  <li><b>안전한 운영을 위해 60~75일에 한 번 수동 실행</b>을 권장합니다.</li>
